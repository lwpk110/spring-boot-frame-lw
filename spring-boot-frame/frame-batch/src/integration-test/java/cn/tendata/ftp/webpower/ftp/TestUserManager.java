...
public class TestUserManager extends AbstractUserManager {
    ...
    public static final String FTP_ROOT_DIR = "build" + File.separator + "ftproot";
    public static final String LOCAL_FTP_TEMP_DIR = "build" + File.separator + "local-ftp-temp";
    public static final String SERVER_FTP_DOWNLOAD_DIR = "build" + File.separator + "ftproot" + File.separator + "download";
    public static final String SERVER_FTP_UPLOAD_DIR = "build" + File.separator + "ftproot" + File.separator + "upload";
