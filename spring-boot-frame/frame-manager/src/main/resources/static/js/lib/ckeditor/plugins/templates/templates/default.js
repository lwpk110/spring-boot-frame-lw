...
CKEDITOR.addTemplates(
            "default",
            {
                ...
                templates:[
                            ...
                            {title:"My Templates 1",
                             image:"zdy1.png",
                             description:"A title with some text and a table.",
                             html:'<table  border="0" cellspacing="0" cellpadding="0" align="center"><tr><td style="background-color: rgb(253, 250, 243);"><img src="images/u1.png" alt=""></td></tr><tr><td style="background-color: rgb(255, 255, 255);text-align: center;"><strong><em><span style="color:#8B4513;font-family:tahoma,geneva,sans-serif;font-size:26px;">Season Floral &amp; Gift</span></em></strong></td></tr><tr><td style="background-color: rgb(255, 255, 255);text-align: left;"><p style="color:#666;font-family:tahoma,geneva,sans-serif;font-size:14px;">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas feugiat consequat diam. Maecenas metus. Vivamus diam purus, cursus a, commodo non, facilisis vitae, nulla. Aenean dictum lacinia tortor. Nunc iaculis, nibh non iaculis aliquam, orci felis euismod neque, sed ornare massa mauris sed velit. Nulla pretium mi et risus.</p></td></tr><tr><td style="background-color: rgb(255, 255, 255);text-align: center;"><img src="images/u68.png" alt=""></td></tr></table>'
                            }
                ]
            } 
);